...
public class NewAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.appwidget_update, dateString+" "+cal.getDate()+'/'+cal.getMonth()+'/'+cal.getYear());
        views.setTextViewText(R.id.appwidget_date, dateString+", "+cal.getDate()+'/'+cal.getMonth()+'/'+cal.getYear());
